...
function ScripturaCalendarLiturgy( $date = '', $links = '', $html = '' )
{
	...
	$link[ '0101' ] = '//a-propos-de-marie-mere-de-dieu/';
	$link[ '0201' ] = '//basile-de-cesaree';
	$link[ '0301' ] = '//litanies-du-saint-nom-de-jesus';
	$link[ '0501' ] = '';
	//$link[ '0601' ] = '//l-etoile-de-l-epiphanie-benoit-xvi'; // Pas pour la France
	$link[ '0701' ] = '';
	$link[ '0801' ] = '';
	$link[ '1101' ] = '';
	$link[ '1201' ] = '';
	$link[ '1301' ] = '';
	$link[ '1501' ] = '';
	$link[ '1701' ] = '//antoine-le-grand';
	$link[ '2001' ] = '';
	$link[ '2101' ] = '';
	$link[ '2201' ] = '';
	$link[ '2401' ] = '//francois-de-sales';
	$link[ '2501' ] = '//la-conversion-de-saint-paul';
	$link[ '2601' ] = '//timothee-et-tite';
	$link[ '2701' ] = '//angele-merici';
	$link[ '2801' ] = '//thomas-aquinas';
	$link[ '3101' ] = '';
	$link[ '0202' ] = '//presentation-du-seigneur-au-temple-benoit-xvi';
	$link[ '0302' ] = '';
	$link[ '0402' ] = '';
	$link[ '0502' ] = '';
	$link[ '0602' ] = '';
	...
	$link[ '1002' ] = '';
	$link[ '1002' ] = '';
	$link[ '1402' ] = '//cyrille-et-methode';
	$link[ '1502' ] = '';
	$link[ '1702' ] = '';
	$link[ '1802' ] = '//bernadette-soubirous';
	$link[ '2102' ] = '//pierre-damien';
	...
	$link[ '0803' ] = '';
	$link[ '0903' ] = '';
	$link[ '1703' ] = '//lorica-de-saint-patrick';
	$link[ '1803' ] = '//cyrille-de-jerusalem';
	$link[ '1903' ] = '//saint-joseph';
	$link[ '2303' ] = '';
	$link[ '2503' ] = '//ne-tarde-plus-vierge-marie-donne-ta-reponse-bernard-de-clairvaux'; //voir conditions php plus loin...
	$link[ '0204' ] = '';
	$link[ '0404' ] = '//isidore-de-seville';
	$link[ '0504' ] = '//vincent-ferrier';
	$link[ '0704' ] = '';
	$link[ '1104' ] = '';
	$link[ '1304' ] = '';
	$link[ '2104' ] = '//anselme-de-canterbury';
	$link[ '2304' ] = '';
	$link[ '2404' ] = '';
	$link[ '2504' ] = '';
	$link[ '2804' ] = '';
	$link[ '2904' ] = '//catherine-de-sienne';
	$link[ '3004' ] = '';
	$link[ '0105' ] = '//saint-joseph';
	$link[ '0205' ] = '//athanase-d-alexandrie';
	$link[ '0305' ] = '';
	$link[ '0605' ] = '';
	$link[ '1205' ] = '';
	$link[ '1305' ] = '';
	$link[ '1405' ] = '//judas-iscariote-et-matthias';
	$link[ '1805' ] = '';
	$link[ '1905' ] = '';
	$link[ '2005' ] = '//bernardin-de-sienne';
	$link[ '2105' ] = '';
	$link[ '2205' ] = '//prieres-a-sainte-rita';
	$link[ '2505' ] = '//bede-le-venerable';
	$link[ '2605' ] = '';
	$link[ '2705' ] = '//augustin-de-canterbury';
	$link[ '3005' ] = '//jeanne-d-arc';
	$link[ '3105' ] = '';
	$link[ '0106' ] = '//justin-martyr';
	$link[ '0206' ] = '';
	$link[ '0306' ] = '';
	$link[ '0406' ] = '';
	$link[ '0506' ] = '';
	$link[ '0606' ] = '';
	$link[ '0906' ] = '//ephrem-le-syrien';
	$link[ '1106' ] = '';
	$link[ '1306' ] = '//antoine-de-padoue';
	$link[ '1906' ] = '';
	$link[ '2106' ] = '';
	$link[ '2206' ] = '//paulin-de-nole';
	$link[ '2406' ] = '//la-nativite-de-saint-jean-baptiste-joseph-marie-verlinde';
	$link[ '2606' ] = '';
	$link[ '2706' ] = '//cyrille-d-alexandrie';
	$link[ '2806' ] = '//irenee-de-lyon';
	$link[ '2906' ] = '';
	$link[ '3006' ] = '';
	$link[ '0307' ] = '//thomas-apotre';
	$link[ '0407' ] = '';
	$link[ '0507' ] = '';
	$link[ '0607' ] = '//maria-goretti';
	$link[ '0907' ] = '';
	$link[ '1007' ] = '//marcienne-de-dellys';
	$link[ '1107' ] = '//benoit-de-nursie';
	$link[ '1307' ] = '';
	$link[ '1407' ] = '';
	$link[ '1507' ] = '//bonaventure-de-bagnoregio';
	$link[ '1607' ] = '';
	$link[ '1707' ] = '';
	$link[ '2007' ] = '//apollinaire-de-ravenne';
	$link[ '2107' ] = '//laurent-de-brindisi';
	$link[ '2207' ] = '//marie-madeleine';
	$link[ '2307' ] = '//brigitte-de-suede';
	$link[ '2407' ] = '';
	$link[ '2507' ] = '//jacques-le-majeur';
	$link[ '2607' ] = '//saints-anne-et-joachim-jean-damascene';
	$link[ '2907' ] = '';
	$link[ '3007' ] = '//pierre-chrysologue';
	$link[ '3107' ] = '//ignace-de-loyola';
	$link[ '0108' ] = '//alphonse-de-liguori';
	$link[ '0208' ] = '//eusebe-de-verceil';
	$link[ '0408' ] = '//jean-baptiste-marie-vianney';
	$link[ '0508' ] = '';
	$link[ '0608' ] = '//sur-la-transfiguration-leon-le-grand';
	$link[ '0708' ] = '';
	$link[ '0808' ] = '//dominique-de-guzman';
	$link[ '0908' ] = '';
	$link[ '1008' ] = '';
	$link[ '1108' ] = '//claire-d-assise';
	$link[ '1208' ] = '';
	$link[ '1308' ] = '';
	$link[ '1408' ] = '';
	$link[ '1508' ] = '//tag/assomption';
	$link[ '1608' ] = '//etienne-de-hongrie';
	$link[ '1908' ] = '//jean-eudes';
	$link[ '2008' ] = '//bernard-de-clairvaux';
	$link[ '2108' ] = '//pie-x';
	$link[ '2208' ] = '//marie-reine-de-l-univers-jean-paul-ii';
	$link[ '2308' ] = '';
	$link[ '2408' ] = '//barthelemy-apotre';
	$link[ '2508' ] = '//louis-ix';
	$link[ '2608' ] = '//cesaire-d-arles';
	$link[ '2708' ] = '';
	$link[ '2808' ] = '//augustin-d-hippone';
	$link[ '2908' ] = '//l-exemple-de-jean-baptiste-pierre-chrysologue';
	$link[ '3008' ] = '';
	$link[ '0309' ] = '//gregoire-le-grand';
	$link[ '0809' ] = '//nativite-de-la-vierge-marie-joseph-marie-verlinde';
	$link[ '0909' ] = '';
	$link[ '1009' ] = '';
	$link[ '1209' ] = '//litaniae-lauretanae';
	$link[ '1309' ] = '//jean-chrysostome';
	$link[ '1409' ] = '';
	$link[ '1509' ] = '';
	$link[ '1609' ] = '';
	$link[ '1709' ] = '//robert-bellarmin';
	$link[ '1809' ] = '';
	$link[ '1909' ] = '';
	$link[ '2009' ] = '';
	$link[ '2109' ] = '';
	...
	$link[ '2509' ] = '';
	$link[ '2609' ] = '';
	$link[ '2709' ] = '//vincent-de-paul';
	$link[ '2809' ] = '';
	$link[ '2909' ] = '';
	$link[ '3009' ] = '//jerome-de-stridon';
	$link[ '0110' ] = '//therese-de-lisieux';
	$link[ '0210' ] = '';
	$link[ '0410' ] = '//francois-d-assise';
	$link[ '0610' ] = '';
	$link[ '0710' ] = '';
	$link[ '0910' ] = '';
	$link[ '1410' ] = '';
	$link[ '1510' ] = '//therese-de-jesus';
	$link[ '1610' ] = '';
	$link[ '1710' ] = '';
	$link[ '1810' ] = '';
	$link[ '1910' ] = '';
	...
	$link[ '2810' ] = '';
	$link[ '3010' ] = '';
	$link[ '0111' ] = '//tag/communion-des-saints';
	$link[ '0211' ] = 'Commémoration de tous les fidèles défunts';
	$link[ '0311' ] = '//martin-de-porres';
	$link[ '0411' ] = '//charles-borromee';
	$link[ '0711' ] = '//willibrord-d-utrecht';
	$link[ '0911' ] = '';
	$link[ '1011' ] = '//leon-le-grand';
	$link[ '1111' ] = '//martin-de-tours';
	$link[ '1211' ] = '//josaphat-de-polotsk';
	$link[ '1511' ] = '//albert-le-grand';
	$link[ '1611' ] = '//marguerite-de-hongrie';
	$link[ '1711' ] = '//elisabeth-de-hongrie';
	$link[ '1811' ] = '';
	$link[ '2111' ] = '//la-presentation-de-la-vierge-marie-au-temple-frere-elie';
	$link[ '2211' ] = '//cecile-de-rome';
	$link[ '2311' ] = '//clement-de-rome';
	$link[ '2411' ] = '';
	$link[ '2511' ] = '//catherine-d-alexandrie';
	$link[ '3011' ] = '//andre-le-protoclet';
	$link[ '0312' ] = '//francois-xavier';
	$link[ '0412' ] = '//jean-damascene';
	$link[ '0512' ] = '//crispine-de-thagare';
	$link[ '0612' ] = '//nicolas-de-myre';
	$link[ '0712' ] = '//ambroise-de-milan';
	$link[ '0812' ] = '//l-immaculee-conception-antonin-dalmace-sertillanges';
	$link[ '1112' ] = '//damase-i';
	$link[ '1312' ] = '//lucie-de-syracuse';
	$link[ '1412' ] = '//jean-de-la-croix';
	$link[ '1512' ] = '//pierre-canisius';
	$link[ '2312' ] = '//jean-de-kenty';
	$link[ '2512' ] = '//la-naissance-du-seigneur-maxime-de-turin';
	$link[ '2612' ] = '//etienne-le-protomartyr';
	$link[ '2712' ] = '//jean-l-evangeliste';
	$link[ '2812' ] = '//les-saints-innocents-pierre-chrysologue';
	$link[ '2912' ] = '//thomas-becket';
	$link[ '3112' ] = '';
