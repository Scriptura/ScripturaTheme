...
if ( is_admin() ) {
	...
	?>
	<div class="wrap">
		<h2><?php _e( 'Contact Forms', 'scriptura' ); ?></h2>
		<form method="post" action="">
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th scope="row">
							<label><?php _e( 'Address(s) email the contact form', 'scriptura' ); ?></label>
						</th>
						<td>
							...
							<p class="description"><?php _e( 'The emails are beings separated by commas without spaces if you want to save many. The contact form ensures privacy: email will not appear clearly on the site. If the field is left blank the default will be the address of the first administrator.', 'scriptura' ); ?></p>
						</td>
					</tr>
				</tbody>
			</table>
